        ...
        <div class="">
            ...
            <form action="{{ route('admin.settings.banner.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" accept=".mp4" max-size="5120000" type="file" id="mainBanner"
                        name="banner">
                </div>

                <div class="mb-3">
                    <label for="imageOverlay" class="form-label">Lớp ảnh phủ:</label>
                    <input class="form-control" accept=".png" max-size="5120000" type="file" id="imageOverlay"
                        name="image">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <label class="switch">
                        <input type="checkbox" id="isActive" name="isActive" value="true" {{ $isActive ? 'checked' : '' }}>
