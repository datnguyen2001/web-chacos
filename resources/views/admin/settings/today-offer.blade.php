    ...
    <main id="main" class="main d-flex flex-column justify-content-center">
                    ...
                    @foreach ($search as $key => $cate)
                        <tr id="category-{{ $cate->id }}">
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{url('admin/settings/destroy-today_offer/'.$cate->id)}}" class="btn btn-danger btn-delete"><i
        ...
        @foreach ($search as $key => $cate)
            ...
            <div class="modal fade" id="editCategory{{ $cate->id }}" data-bs-backdrop="static"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <form method="POST" action="{{ route('admin.settings.update.today_offer', ['id' => $cate->id]) }}"
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label for="edit-category-name-{{ $cate->id }}" class="form-label">Title</label>
                                    <input type="text" class="form-control edit-category-slug"
                                           id="edit-category-slug-{{ $cate->id }}" name="title"
