...
@section('content')
    <div class="content-contact-center">
        <p class="title-page-order-status">Xem trạng thái của đơn đặt hàng bằng cách nhập số đơn đặt hàng và mã zip thanh
            toán bên dưới.
            <br />
            Để xem toàn bộ lịch sử đơn hàng bạn phải đăng nhập .
        </p>
        <p class="title-bold-page-order-status">Nhận trạng thái của một đơn hàng</p>
        <div class="">
