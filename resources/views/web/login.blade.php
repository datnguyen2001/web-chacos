        ...
        <form action="{{ route('sign-in') }}" method="POST">
            ...
            <div class="box-content-login-register">
                <div class="item-login-register">
                    ...
                    <p class="content-login-register">Nếu bạn là người dùng đã đăng ký, vui lòng nhập email và mật khẩu của
                        bạn.
                    </p>
                    <label for="email-login" class="lable-login">Email của bạn</label>
                    <input type="text" id="email-login" class="inpit-login" name="email">
                    <label for="pass-login" class="lable-login">Mật khẩu</label>
                    <input type="password" id="pass-login" class="inpit-login" name="password">
                ...
                <div class="item-login-register">
                    ...
                    <ul>
                        <li><strong>Thanh toán nhanh hơn</strong> Lưu trữ các phương thức thanh toán và địa chỉ giao hàng
                            của
                            bạn để sử dụng sau.<br><br></li>
                        <li><strong>Theo dõi đơn hàng</strong> Lưu và xem lại lịch sử đơn hàng.<br><br></li>

                    </ul>
                    <p class="content-login-register">Nếu bạn dưới 18 tuổi, bạn phải có sự cho phép của cha mẹ hoặc người
                        giám
                        hộ để gửi thông tin cá nhân của bạn.</p>
