    ...
    <script>
        $(document).ready(function() {
            ...
            $('#offcanvasRightCart').on('shown.bs.offcanvas', function() {
                ...
                fetch(
                        '{{ route('get.cart.data') }}'
                    ) // Replace with the actual route to your controller method
                    ...
                    <div class="item-product-cart">
                        ...
                        <div class="mini-cart-pricing">
                            <div class="mini-cart-price-each">
                                <div class="label" aria-label="Each" aria-labelledby="mini-cartprice-value-label-0">
                                    Each
                                </div>
                                <span id="mini-cart-price-value-label-0" class="mini-cart-price bfx-price" data-price="${price}">
                                    ${price}
                                </span>
                            </div>
                            <div class="quantity-main-wrapper">
                                <div class="label" aria-labelledby="mini-cartprice-value-label-0">
                                    Quantity
                                </div>
                                <div class="quantity-wrapper">
                                    ...
                                    <input type="number" class="value input-quantity-sp" readonly id="mini-cart-quantity-value-0" value="${quantity}">
                                    <span>
