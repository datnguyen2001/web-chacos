            ...
            <div id="spc-primary" class="col-xs-12 col-lg-7 col-md-6">
                <header class="spc-header">
                    ...
                    <div class="spc-header-right">
                        <div class="spc-secure-checkout"><i class="fa-solid fa-lock"></i><span class="spc-badge-text" tabindex="0">Secure Checkout</span></div>
                    </div>
                </header>
                <div class="wrapper option-1 option-1-1 " id="checkout-bs-nav" >
                    <ol class="stepper">
                        <li class="stepper__item stepper__visited__state"><a href="https://www.chacos.com/US/en/cart"
                                                                             class="stepper__title"><span
                                    class="stepper__title">Cart</span></a></li>
                        <li class="stepper__item stepper__current__state" aria-current="step"><span
                                class="stepper__title"> Checkout </span></li>
                        <li class="stepper__item "><span class="stepper__title"> Complete </span></li>
                    </ol>
                </div>
                <h2 class="spc-section-welcome">Welcome Back,<span
                        class="spc-customer-name"> dev!</span></h2>
                <div class="spc-loader-wrapper">
                    <div class="spc-section-heading row between-xs middle-xs container-fluid"><h2
                            class="spc-section-heading-title" >Shipping
                            Information</h2><span class="spc-section-heading-step">Step 1 of 2</span>
                    </div>
                    <div class="tt-select">
                        <select>
                ...
                <div class="spc-loader-wrapper">
                    <section class="spc-section spc-section__billing-empty" id="billing-section">
                        <div class="spc-section-heading row between-xs middle-xs container-fluid"><h2
                                class="spc-section-heading-title">Billing
                                Information</h2><span class="spc-section-heading-step">Step 2 of 2</span>
                        </div>
                    </section>
                </div>
            </div>
            <div class="order-summary-container col-lg-5 col-md-6 col-xs-12">
                <div id="spc-secondary" class="order-summary">
                    <div class="order-summary-header" role="presentation">
                        <div class="order-summary-header-title"><h2 >Order Summary</h2>
                        </div>
                        <div id="backToCartLink" ><a class="back-to-cart-anchor" href="">Back
                                To Cart</a><a href=""
                                              class="MiniCart__HeaderActions--cart icon-mini-cart position-relative" title="View Cart"
                                    ...
                                    class="mini-cart-quantity-bag">2</span></a></div>
                    </div>
                        ...
                        <div class="transitioner">
                            <div class="spc-loader-wrapper spc-loader-wrapper-sp">
                                <ul class="product-list">
                                    <li class="product-item">
                                        <a href="" class="product-item-name"><h3 class="spc-product-name">Ramble Puff
                                                Clog</h3></a>
                                        <div class="row product-item-container">
                                            <div class="product-image col-sm-6 col-xs-6"><a
                                                    href=""
                                                    class="product-item-name" >
                                                    <picture>
                                                        <img
                                                            src="https://s7d4.scene7.com/is/image/WolverineWorldWide/CHAW-JCH109308-100721-F22-000?$dw-checkoutcartthm$&amp;fmt=jpeg"
                                                            alt="Ramble Puff Clog, Black, dynamic"></picture>
                                                </a></div>
                                            <div class="product-info container-fluid col-sm-6 col-xs-6">
                                                <div class="row">
                                                    <div class="col-xs-12 full-xs"><p tabindex="0">Color: Black</p>
                                                        <p >Size: 8 M</p>
                                                        <p>Item #195018203618</p><a
                                                            class="spc-edit-product" href=""
                                                            aria-label="Edit Product">Edit</a></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row pt-20 productcarddetails-title">
                                            <div class="col-xs-4 col-sm-4 col-4 full-xs product-price-container"><p
                                                    >Each</p></div>
                                            <div
                                        ...
                                        <div class="row productcarddetails-value">
                                            <div class="col-xs-4 col-sm-4 col-4 full-xs product-price-container">
                                                <div class="product-price" >$75.00
                                                </div>
                                            </div>
                                            <div
                                                class="col-xs-4 col-4 col-sm-4 full-xs product-quantity-value text-center">
                                                <p>1</p></div>
                                            <div
                                                class="col-xs-4 col-sm-4 col-4 full-xs product-price-container">
                                                <div class="product-price-summary">
                                                    <div class="product-price-summary">$75.00
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="totals-table">
                                <table>
                                    ...
                                    <tr>
                                        <td>STANDARD<br><span style="font-size: 13px;font-weight: 400">Delivers by Sun, 5/12</span></td>
                                        <td class="free-shipping text-end" >FREE</td>
                                    </tr>
                                </table>
                                <table class="mt-0">
                                    <tr>
                                        <td class="spc-sales-tax">Sales Tax</td>
                                        <td class="spc-sales-tax text-end">$100</td>
                                    </tr>
                                </table>
                        ...
                        <div id="checkout-customer-help">
                            ...
                            <div class="cart-banner-box">
                                ...
                                <p>
                                    ...
                                    <span class="visually-hidden">Monday through Friday from 8am to 9pm eastern time, and Saturday through Sunday from 9am to 6pm</span>
                                </p>
